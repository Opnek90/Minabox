...
class MediaDownloaderClient:
    ...
    The service URL is injected via MEDIA_DOWNLOADER_URL env var
    (default: http://media-downloader:8007).
    """
    ...
    async def download_video(self, url: str) -> dict[str, Any]:
        ...
        Returns dict with: file_path, title, artist, album, duration_ms,
    ...
    async def get_video_info(self, url: str) -> dict[str, Any]:
        ...
        Returns dict with: title, artist, duration_ms, thumbnail, video_id.
        """
